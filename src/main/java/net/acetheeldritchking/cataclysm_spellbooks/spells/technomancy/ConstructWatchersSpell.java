...
public class ConstructWatchersSpell extends AbstractHarbingerSpell {
    private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath(CataclysmSpellbooks.MOD_ID, "construct_watchers");
